 ...
 */
public class SetTwo extends Fragment implements OnGroupClickListener,
	...
	private static String TAG = "SetTwo";
	 ...
	 */
	public static SetTwo newInstance(AppActivity activity, int sectionNumber) {
		this_activity= activity;
		_context = activity;
		SetTwo fragment = new SetTwo();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater
				.inflate(R.layout.fragment_set_two, container, false);
		...
		listAdapter = new ExpandableListAdapter(getActivity(), _context,
